...
/** localStorage key prefix for translated JSON. */
export const I18N_CACHE_PREFIX = "i18n:";

/** Pre-rename prefix, swept on load so stale entries do not linger in localStorage. */
export const LEGACY_I18N_CACHE_PREFIX = "v2:i18n:";
...
export const I18N_HASH_COOKIE_NAME = "i18n_hash";
